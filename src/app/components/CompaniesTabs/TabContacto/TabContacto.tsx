...
import { DescriptionCompany, SocialMediaCompany, SpecialitiesCompany, ContactInfoCompany } from "../../ProSection";
...
export default function TabContacto({description, socialMedia, tags, webSite, emails, phones, countries, nit}: TabContactoProps) {
  return (
    <article className="text-center">
      ...
      <ContactInfoCompany nit={nit} countries={countries} emails={emails} webSite={webSite} phones={phones}/>
